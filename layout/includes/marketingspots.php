...
function celoe_marketingspot()
{
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_celoe_get_setting('mspot' . $i . 'icon');
        $msptitle = theme_celoe_get_setting('mspot' . $i . 'title');
        $mspdescription = theme_celoe_get_setting('mspot' . $i . 'desc');
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_celoe_get_setting('mspot' . $i . 'icon');
        $msptitle = theme_celoe_get_setting('mspot' . $i . 'title');
        $msptitle = theme_celoe_lang($msptitle);
        $mspdescription = theme_celoe_get_setting('mspot' . $i . 'desc');
        $mspdescription = theme_celoe_lang($mspdescription);

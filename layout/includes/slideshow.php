...
function slideshow()
{
  ...
  $numberofslides = theme_celoe_get_setting('numberofslides');
  ...
  if ($numberofslides) {
    ...
    for ($s1 = 1; $s1 <= $numberofslides; $s1++) :
      $clstxt2 = ($s1 == "1") ? ' active' : '';
      $slidecaption = theme_celoe_get_setting('slide' . $s1 . 'caption', true);
      $slidecaption = theme_celoe_lang($slidecaption);

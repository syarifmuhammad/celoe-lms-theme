...
/**
 * Strings for component 'theme_celoe', language 'en'
 * @package     theme_celoe
...
$string['pluginname'] = 'Celoe';
$string['address'] = 'Address';
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot">
<img class=img-polaroid src="celoe/pix/screenshot.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle Celoe theme</h3>
<p> This theme is based on the Boost based Moodle theme. </p>
<p>Authors: CeLoe Dev Team<br>
Contact: celoe@ittelkom-sby.ac.id<br>
Website: <a href="http://www.celoe.ittelkom-sby.ac.id.com">www.celoe.ittelkom-sby.ac.id</a><br> </p>';
$string['configtitle'] = 'Celoe';
$string['connectus'] = 'Celoe with us';
